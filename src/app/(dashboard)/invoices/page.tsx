...
export default function InvoicesPage() {
  ...
  const handleCreateInvoice = () => {
    ...
    toast({ title: "Invoice Created", description: "The new invoice has been generated successfully." });
        ...
        <div className="flex justify-end pt-8">
          <div className="w-80 space-y-4 border-t-4 border-primary/10 pt-8">
            ...
            <div className="flex justify-between items-center pt-6 border-t border-muted/50">
              ...
              <span className="text-3xl font-black text-primary">{invCurrencySymbol}{invoice.total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
            </div>
          </div>
        </div>
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div key={index} className="flex gap-3 items-end">
                      <div className="flex-1 space-y-1">
                        ...
                        >
                          ...
                          <SelectContent>
                            {products.map(p => (
                              <SelectItem key={p.id} value={p.id}>{p.name} - {currencySymbol}{isLKR ? p.priceLKR.toLocaleString() : p.priceUSD}</SelectItem>
                            ))}
                          </SelectContent>
                        </Select>
                      </div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateInvoice}>Finalize & Save Invoice</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
